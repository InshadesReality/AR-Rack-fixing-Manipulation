...
namespace GoogleARCore.Examples.ObjectManipulation
{
    ...
    public class AndyPlacementManipulator : Manipulator
    {
            ...
            if (gesture.TargetObject != null)
            {
                    ...
                    gesture.StartPosition.x, gesture.StartPosition.y, raycastFilter, out hit))
                {
                    ...
                    else
                    {
                        ...
                        GameObject Object = Instantiate(Godrej, hit.Pose.position, hit.Pose.rotation);
                        ...
                        Object.transform.parent = manipulator.transform;
        ...
        {
            flag = true;
            GameObject[] destroyable = GameObject.FindGameObjectsWithTag("Destroy");
            foreach (GameObject o in destroyable)
                Destroy(o);
